...
$config->setValue('common.remote.verificator.sign.public_key_path', __DIR__ . '/public_key');
...
try {
    ...
    $subject = new Subject('man.create', new SubjectHttpNotifyWay(new UriPair('http://localhost/extended/', 'index.php')));
